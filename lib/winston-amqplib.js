...
class WinstonAmqplib {
    constructor(options, amqpOptions) {       
        ...
        this.autoCloseChannel = amqpOptions.autoCloseChannel || true;
        this.autoCloseConnection = amqpOptions.autoCloseConnection || true;
        ...
        if(!amqpOptions.connection && !amqpOptions.channel) {
            WinstonAmqplib.createConnection(amqpOptions)
				.then((connection) => {
					amqpOptions.connection = connection;
					this._connection = connection;
					return WinstonAmqplib.setupChannel(amqpOptions);
				})
                .then((channel) => {
